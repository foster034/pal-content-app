-- ============================================
-- COMPLETE ROLE SETUP MIGRATION (FIXED)
-- ============================================
-- This migration:
-- 1. Ensures roles table exists with INTEGER id
...
-- STEP 4: Add role_id column to profiles (INTEGER to match roles.id)
-- ============================================
...
-- STEP 8: Set default for role_id (tech role)
-- ============================================
-- Note: We'll set the default in the trigger instead of here
-- because PostgreSQL doesn't support subqueries in DEFAULT expressions

-- STEP 9: Create index for performance
-- ============================================
CREATE INDEX IF NOT EXISTS idx_profiles_role_id ON profiles(role_id);

-- STEP 10: Update auto-create profile trigger
-- ============================================
...
-- MIGRATION COMPLETE! ✅
-- ============================================
-- ✅ roles table created and populated (INTEGER id)
-- ✅ profiles.role_id linked to roles table (INTEGER)
