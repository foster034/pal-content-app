  ...
  const handleModernJobSubmission = async (data: any) => {
    try {
      ...
      const jobSubmissionData = {
        ...
        franchiseeId: techSession.franchisee.id,
        client: {
      ...
      if (data.photos && data.photos.length > 0) {
        ...
        for (const [photoType, photos] of Object.entries(photosByType)) {
          ...
          typeFormData.append('franchiseeId', techSession.franchisee.id);
          typeFormData.append('photoType', photoType);
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <Button
                        ...
                        className="flex-1 h-12 bg-white hover:bg-gray-50 border border-gray-300 text-gray-900 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm font-medium"
                      >
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  {availableCameras.length > 1 && (
                    <Button
                      ...
                      className="w-14 h-14 sm:w-12 sm:h-12 bg-white hover:bg-gray-50 border border-gray-300 text-gray-900 rounded-full flex items-center justify-center transition-colors min-h-[44px] min-w-[44px] touch-manipulation"
