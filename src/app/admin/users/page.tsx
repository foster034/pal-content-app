const users = [
  ...
  { id: 4, name: 'Sarah Wilson', email: 'sarah@example.com', status: 'Active', joinDate: '2024-04-05' },
  { id: 5, name: 'Tom Brown', email: 'tom@example.com', status: 'Active', joinDate: '2024-05-12' },
];
